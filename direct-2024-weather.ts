...
const regionalWeatherPatterns = {
  ...
  'January': {
    'South': { tempRange: [45, 55], humidity: [65, 80], precipitation: 0.1, conditions: ['Clear', 'Partly Cloudy'] },
    'Southeast': { tempRange: [40, 50], humidity: [60, 75], precipitation: 0.1, conditions: ['Clear', 'Partly Cloudy'] },
    'Midwest': { tempRange: [20, 30], humidity: [70, 85], precipitation: 0.1, conditions: ['Snow', 'Cloudy'] },
    'Northeast': { tempRange: [20, 30], humidity: [65, 80], precipitation: 0.1, conditions: ['Snow', 'Cloudy'] },
    'Plains': { tempRange: [25, 35], humidity: [55, 70], precipitation: 0.1, conditions: ['Clear', 'Snow'] },
    'West': { tempRange: [50, 60], humidity: [50, 65], precipitation: 0.2, conditions: ['Rain', 'Cloudy'] },
    'Southwest': { tempRange: [55, 65], humidity: [35, 50], precipitation: 0.0, conditions: ['Clear', 'Sunny'] },
    'Northwest': { tempRange: [35, 45], humidity: [80, 95], precipitation: 0.5, conditions: ['Rain', 'Cloudy'] },
    'Mountain': { tempRange: [15, 25], humidity: [65, 80], precipitation: 0.3, conditions: ['Snow', 'Clear'] }
  }
};
...
async function collect2024Weather() {
  console.log('🌤️ Direct 2024 Weather Data Collection');
  console.log('Using realistic weather simulation based on regional patterns');
  
  try {
    // Get all 2024 games that need weather data
