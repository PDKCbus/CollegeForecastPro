-- Production Blog Posts Seeding Script
-- Run this in your production Docker container with:
-- docker-compose --env-file .env.production exec app psql $DATABASE_URL -f /app/PRODUCTION_BLOG_SEED.sql

-- First, check if blog posts already exist
SELECT COUNT(*) as existing_blog_count FROM blog_posts;

-- If the count is 0, run the following INSERT statements:
...
(
  '2025 College Football Playoff Expansion: What It Means for Rankings and Betting',
  '2025-cfb-playoff-expansion-rankings-betting',
  'The expanded College Football Playoff format changes everything about how we analyze teams and betting value. Our comprehensive guide breaks down the new system''s impact on rankings, at-large bids, and betting strategies for the 2025 season.',
  'The 2025 college football season brings the most significant change to the sport since the BCS era ended: a 12-team playoff format that fundamentally alters how we evaluate teams, analyze betting value, and predict outcomes.
...
*Ready to capitalize on the new playoff format? Check out our weekly predictions and playoff probability tracker for the most comprehensive college football analysis available.*',
  'Analysis',
  ARRAY['Playoff', 'Betting Strategy', '2025 Season', 'Rankings', 'CFP'],
  true,
  true,
  '2025 College Football Playoff Expansion Guide | Betting Analysis & Predictions',
  'Complete analysis of the 12-team College Football Playoff format and its impact on betting strategies, rankings, and season predictions for 2025.',
  247,
  '2025-07-28 14:30:00',
  '2025-07-28 14:30:00'
),
(
  'Understanding College Football Betting Lines: A Comprehensive Guide for Beginners',
  'college-football-betting-lines-guide',
  'New to college football betting? Our comprehensive guide covers point spreads, over/unders, moneylines, and advanced betting concepts with real examples and strategies from our expert analysts.',
  'College football betting can seem overwhelming for newcomers, but understanding the fundamentals opens up a world of strategic opportunities. At Rick''s Picks, we''ve helped thousands of bettors learn the ropes and develop winning strategies.
...
**Strategic Application**: Lines of 2.5, 6.5, 9.5, and 13.5 often provide better value than key numbers.',
  'Strategy',
  ARRAY['Betting Guide', 'Beginners', 'Strategy', 'Point Spreads', 'Bankroll Management'],
  true,
  true,
  'College Football Betting Guide for Beginners | Point Spreads, Strategy & Tips',
  'Complete beginner''s guide to college football betting including point spreads, over/unders, bankroll management, and winning strategies from expert analysts.',
  189,
  '2025-07-22 09:15:00',
  '2025-07-22 09:15:00'
),
(
  'Week 1 College Football Predictions: Top Upset Alerts and Betting Value',
  'week-1-college-football-predictions-upsets-betting-value',
  'Our algorithmic analysis identifies the biggest upset potential and betting value for Week 1 of college football. Discover which favorites are overvalued and which underdogs offer significant upside.',
  'Week 1 of college football presents unique challenges and opportunities for bettors. Teams are untested, rosters have changed significantly, and public perception often doesn''t match reality. Our advanced analytics have identified several situations where betting value exists.
...
The Thundering Herd has the experience edge and motivation to keep this game closer than the spread suggests.',
  'Previews',
  ARRAY['Week 1', 'Predictions', 'Upset Alerts', 'Betting Value', 'College Football'],
  true,
  false,
  'Week 1 College Football Predictions | Upset Alerts & Betting Value Analysis',
  'Expert analysis of Week 1 college football upset potential and betting value. Algorithmic predictions identify overvalued favorites and underdog opportunities.',
  156,
  '2025-08-05 16:45:00',
  '2025-08-05 16:45:00'
),
(
  'How College Football Weather Affects Betting Lines and Game Outcomes',
  'college-football-weather-betting-analysis',
  'Weather conditions can dramatically impact college football games and betting lines. Our comprehensive analysis shows how wind, rain, snow, and temperature affect scoring, turnovers, and betting value.',
  'Weather is one of the most undervalued factors in college football betting. While casual bettors focus on team stats and recent performance, smart money pays attention to weather forecasts and their impact on game dynamics.
...
- Clock management alterations',
  'Analysis',
  ARRAY['Weather', 'Betting Analysis', 'Game Conditions', 'Strategy', 'Environmental Factors'],
  true,
  false,
  'College Football Weather Betting Analysis | How Conditions Affect Games & Lines',
  'Complete guide to how weather conditions impact college football games, betting lines, and outcomes. Expert analysis of wind, rain, snow, and temperature effects.',
  134,
  '2025-07-31 11:20:00',
  '2025-07-31 11:20:00'
),
(
  'The Rise of Group of 5 Programs: Betting Opportunities in College Football''s Second Tier',
  'group-of-5-college-football-betting-opportunities',
  'Group of 5 programs offer unique betting value often overlooked by the public. Our analysis reveals why American, Conference USA, MAC, Mountain West, and Sun Belt teams provide excellent opportunities for sharp bettors.',
  'The Group of 5 conferences (American, Conference USA, MAC, Mountain West, Sun Belt) represent college football''s best-kept secret for savvy bettors. While public attention focuses on Power 5 glamour, significant value exists in these overlooked programs.
...
- Bowl game preparation time advantages',
  'Analysis',
  ARRAY['Group of 5', 'Betting Opportunities', 'Value Betting', 'Conference Analysis', 'Undervalued Teams'],
  true,
  false,
  'Group of 5 College Football Betting Guide | Value in Second Tier Programs',
  'Discover betting opportunities in Group of 5 college football conferences. Analysis of American, MAC, Mountain West, C-USA, and Sun Belt betting value.',
  98,
  '2025-08-08 13:00:00',
  '2025-08-08 13:00:00'
);

-- Verify the blog posts were inserted successfully
SELECT COUNT(*) as total_blog_posts FROM blog_posts;
SELECT title, published, featured FROM blog_posts ORDER BY created_at;